...
$("#save_new_service").click(function () {
    ...
    if (service == "") {
        ...
        var ans = confirm("Save new Horizon Lab Service?");
        if (ans) {
...
$("#delete_service").click(function () {
    ...
    var ans = confirm("Are you sure you want to delete " + service_name + "?"); 
    if (ans) {
...
$("#save_service_detail_changes").click(function () {
    ...
    if (detail_name == "") {
        ...
        var ans = confirm("Are you sure you want to save changes: " + detail_name + "?");
        if (ans) {
